'use strict';
// Generated on 2015-06-23 using generator-wim 0.0.1
...
gulp.task('icons', function () {
    return gulp.src(['src/bower_components/bootstrap/dist/fonts/*.*', 'src/bower_components/fontawesome/fonts/*.*','src/bower_components/themify-icons/fonts/*.*', 'src/bower_components/Ionicons/fonts/*.*'])
